...
\maketitle
\includegraphics[width=0.75\textheight]{../../graphics/SteampunkCity}
\tableofcontents
\newpage
\listoffigures
\newpage
...
three themed non-city areas: a forest, a mountain range, and a desolate 
wasteland. Additionally, the final locale will be \evilcorp .
game will progress through the locations in the order:

\begin{enumerate}
    \item Hometown
    \item Aether Wilds (Forest Region)
    \item City \#1
    \item Mountains
    \item City \#2
...
\begin{figure}[H]
    ...
    \includegraphics[width=\textwidth]{../../graphics/screen-flow-diagram}
\end{figure}
...
\protagonist, the main character of the game, was born in the small town of
\hometown. Her parents, \dad and \mom, are inventors. Working with both hardware
and software, they solve the town's oddly plentiful problems with simple and
clever solutions. Vivian has always felt that her parents' ingenuity had not
been passed on to her. While Vivian had always performed exceptionally in
school, she feels that she is more of a leader than a follower and often has
trouble thinking for herself. She often sees both sides of an argument very
well, and usually is comfortable with a middleground solution; when she does
have a significant change to her worldview, it's often the result of learning a
new idea from someone else and rarely coming up with anything original herself.
...
\begin{figure}[H]
\caption{Wilderness Overworld View}
\label{fig:forest}
\centering
\includegraphics[width=0.7\textwidth]{../../graphics/forest_overview}
\end{figure}
...
\subsubsubsection{Overworld Sounds}
\begin{itemize}
...
\subsubsubsection{Combat Sounds}
\begin{itemize}
...
\subsubsubsection{Miscellaneous Sounds}
\begin{itemize}
...
\subsubsubsection{Overworld Ambient Scores}
\begin{itemize}
    \item Home Town
    \item First City
    \item Second City
...
\subsubsubsection{Encounter Action Scores}
\begin{itemize}
    \item Home Town
    \item First City
    \item Second City
...
\subsubsubsection{Cut Scene Scores}
\begin{itemize}
